...
class UserRegistrationForm extends StatefulWidget {
  ...
  UserRegistrationForm(
      {super.key, required this.isAdvocate, required this.userCredential});
...
class _UserRegistrationFormState extends State<UserRegistrationForm> {
  ...
  ValueNotifier<int> maxAllowedCharges = ValueNotifier<int>(18);
      ...
      try {
        ...
        if (!widget.isAdvocate) {
          await FirebaseFirestore.instance
            ...
            'address':
                "${AddressController.text}, ${CityController.text}, ${StateController.text}, ${countryController.text}, ${PinCodeController.text}"
          ...
          await Serverhttphelper.uploadFileWeb(
              barCertificateFile,
              "advocateBarCertificates",
        ...
        userClass.barRegistrationCertificate =
            BarRegistrationCertificateController.text ?? "";
        ...
        maxAllowedCharges.value = ChargeController.text.isNotEmpty
            ? int.parse(ChargeController.text) : 0;
...
//   });
  ...
  void initState() {
    ...
    maxAllowedCharges.value = charges[dropdownValue]!.toInt();
            ...
            child: Form(
              ...
              child:
                ...
                children: [
                      ...
                      try {
                        ...
                        if (_isLoaderVisible && context.mounted) {
                          ...
                          CustomMessenger.defaultMessenger(
                              context, "Did not get Permission");
                        }
                      }
                  ...
                  if (widget.isAdvocate) CustomText.infoText("Experience"),
                  if (widget.isAdvocate)
                      ...
                      onSelected: (String? value) {
                        ...
                        setState(() {
                          ...
                          ChargeController.text =
                              charges[dropdownValue].toString();
                        });
                      },
                      dropdownMenuEntries:
                  ...
                  if (widget.isAdvocate)
                    giveInputField(
                        "Skills", SkillsController, true, TextInputType.text),
                  if (widget.isAdvocate)
                    giveInputField("Charges per minute", ChargeController, true,
                        TextInputType.number,
                        tooltipText: charges.toString(),
                        disable: false,
                        maxValueNotifier: maxAllowedCharges),
...
//                   return null;}
  giveInputField(
    ...
    String tooltipText = "",
    bool disable = false,
    ValueNotifier<int>? maxValueNotifier, // Optional max value
  }) {
    if (maxValueNotifier != null) {
      controller.addListener(() {
        final value = double.tryParse(controller.text) ?? 0.0;
        if (value > maxValueNotifier.value) {
          controller.text = maxValueNotifier.value.toString();
